...
parser.add_argument('-p', '--path', default='../img/9.jpg')
args = parser.parse_args()

detector = dlib.get_frontal_face_detector()
model = FacialExpressionModel("../weights/model.json", "../weights/model_weights.h5")
...
for d in dets:
    ...
    cv2.putText(img, pred, (d.left(), d.top()), font, 1, (255, 255, 0), 2)
cv2.imshow("img", img)
cv2.waitKey(0)
